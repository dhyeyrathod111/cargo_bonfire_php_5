...
{
    protected $permissionCreate = 'Upload.Developer.Create';
    protected $permissionDelete = 'Upload.Developer.Delete';
    protected $permissionEdit   = 'Upload.Developer.Edit';
    protected $permissionView   = 'Upload.Developer.View';
