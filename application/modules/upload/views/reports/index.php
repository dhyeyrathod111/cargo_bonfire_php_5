...
$num_columns	= 19;
$can_delete	= $this->auth->has_permission('Upload.Reports.Delete');
$can_edit		= $this->auth->has_permission('Upload.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/upload/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->MessageType); ?></td>
				<?php else : ?>
