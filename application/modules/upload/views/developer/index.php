...
$num_columns	= 19;
$can_delete	= $this->auth->has_permission('Upload.Developer.Delete');
$can_edit		= $this->auth->has_permission('Upload.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/upload/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->MessageType); ?></td>
				<?php else : ?>
