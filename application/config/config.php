...
|
 */
// $config['base_url']='http://'.$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT']."/cicargo/";

$base_url['base_url'] = "http://localhost/dhyey_rathod/cicargo/";
...
|
 */
$config['encryption_key'] = "5d3a245fe59a848501c8e86dde45b85e";
...
$config['sess_table_name']		= 'ci3_sessions';
$config['sess_match_useragent'] = TRUE; // May duplicate sessions for Safari users when true.
